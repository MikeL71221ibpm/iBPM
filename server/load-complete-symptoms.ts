/**
 * Script to load all symptom segments data from CSV file using full 8-field matching
 * 
 * Optimized for processing all records with proper deduplication by comparing all 8 fields:
 * 1. patient_id, symptom_id, symptom_segment, diagnosis, diagnosis_icd10_code, 
 *    diagnostic_category, symp_prob, ZCode_HRSN
 * 2. Only loading records that don't already exist based on the full field comparison
 * 3. Processing smaller batches with better progress tracking
 */
