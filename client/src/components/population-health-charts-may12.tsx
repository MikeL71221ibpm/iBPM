...
export default function PopulationHealthCharts({ 
  ...
  const getVisualMetadataInfo = () => {
    // Default values
    const totalRecords = 6280; // Total records from the CSV and JSON data sources
    
    // This would be calculated based on filters in a real implementation
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                      ...
                                      <Card className="shadow-md">
                                        <CardHeader className="pb-2 flex flex-row items-center justify-between">
                                          <div>
                                            <CardTitle className="text-lg font-medium">Social Determinants Indicators</CardTitle>
