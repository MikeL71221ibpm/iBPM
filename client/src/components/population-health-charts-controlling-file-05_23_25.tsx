...
const renderLabel = (d: any, displayMode: string) => {
  ...
  if (displayMode === "percentage") {
    ...
    } else if ((d as any).percentage !== undefined) {
      return `${(d as any).percentage}%`;
    } else {
      return "0%";
    }
  } else {
            ...
            <CardFooter className="p-2 flex justify-between">
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  {/* Standardized Export System with Detail Export */}
                  <UnifiedExportSystem
                    chartId="hrsn-indicators"
                    chartTitle="HRSN Indicators"
                    chartData={getFullDataset('HRSN Indicators', true)}
                    variant="buttons"
                    showAllFormats={true}
                  ...
                  <div className="flex-1 h-[calc(45vh-120px)]">
                    <ResponsiveBar
                      ...
                      labelSkipHeight={12}
                      enableLabel={true}
                      label={d => { return displayMode === "percentage" ? ((d as any).percentage !== undefined ? `${(d as any).percentage}%` : "0%") : `${d.value}`; }}
                      labelTextColor={"#000000"}
                      labelPosition="end"
                      labelOffset={-3}
                      theme={{
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  <UnifiedExportSystem
                    ...
                    chartData={getFullDataset('Risk Stratification', true)}
                    variant="buttons"
                    showAllFormats={true}
                    onPrint={() => window.print()}
                  />
            ...
            <CardFooter className="p-2 flex justify-between">
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  {/* Standardized Export System with Detail Export */}
                  <UnifiedExportSystem
                    chartId="symptom-segment"
                    chartTitle="Symptom Segment"
                    chartData={getFullDataset('Symptom Segment', true)}
                    variant="buttons"
                    showAllFormats={true}
                    onPrint={() => window.print()}
                  />
              ...
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  <UnifiedExportSystem
                    ...
                    chartData={getFullDataset('Diagnosis', true)}
                    variant="buttons"
                    showAllFormats={true}
                    onPrint={() => window.print()}
                  />
            ...
            <CardFooter className="p-2 flex justify-between">
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  <UnifiedExportSystem
                    chartId="symptom-id"
                    chartTitle="Symptom ID"
                    chartData={getFullDataset('Symptom ID', true)}
                    variant="buttons"
                    showAllFormats={true}
                    onPrint={() => window.print()}
                  />
            ...
            <CardFooter className="p-2 flex justify-between">
              <Dialog>
                ...
                <DialogContent className="max-w-4xl h-[80vh]">
                  ...
                  {/* Standardized Export System with Detail Export */}
                  <UnifiedExportSystem
                    chartId="diagnostic-category"
                    chartTitle="Diagnostic Category"
                    chartData={getFullDataset('Diagnostic Category', true)}
                    variant="buttons"
                    showAllFormats={true}
                    onPrint={() => window.print()}
                  />
