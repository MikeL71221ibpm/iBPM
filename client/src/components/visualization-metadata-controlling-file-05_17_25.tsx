/**
 * VisualizationMetadata Component (visualization-metadata-controlling-file-05_17_25.tsx)
 * Created: May 17, 2025
 * 
 * Description:
 * This component displays metadata about the data source used in visualizations,
 * including record counts, patient counts, date ranges, and active filters.
 * It can be toggled to show/hide details and can be included or excluded from printing.
 */
