  ...
  return (
    <div className="space-y-4 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 population-health-grid">
        ...
        {/* Diagnosis Chart */}
        {hasDiagnosisData && (
          <Card className={expandedChart === 'diagnosis-chart' ? 'col-span-full' : ''}>
        ...
        {hasDiagnosticCategoryData && (
          <Card className={expandedChart === 'diagnostic-category-chart' ? 'col-span-full' : ''}>
            <CardHeader className="pb-2">
              <CardTitle className="flex justify-between items-center">
        ...
        {/* Symptom ID Chart */}
        {hasSymptomIDData && (
          <Card className={expandedChart === 'symptom-id-chart' ? 'col-span-full' : ''}>
            <CardHeader className="pb-2">
              <CardTitle className="flex justify-between items-center">
      ...
      <div className="mt-8 text-center text-sm text-gray-500">
        Currently displaying {displayMode === 'count' ? 'count' : 'percentage'} values. 
        Click the toggle button above to switch.
      </div>
    </div>
  );
}