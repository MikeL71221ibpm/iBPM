 ...
 * Receipt List Page Controller
 * 
 * This file controls the /receipts route
 * Displays a list of all receipts for the authenticated user
 * Provides navigation to individual receipt details
 * 
