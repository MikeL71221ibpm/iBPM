// Backup of nivo-scatter-view-themed.tsx with improved download buttons
// Timestamp: 05/03/2025 17:30 UTC
// Contains:
// - Fixed date labels alignment by increasing margins to 280px
// - Added download buttons (Excel/CSV, PDF, PNG) to full page view
// - Positioned date labels at bottom of full page view with proper alignment
// - Moved download buttons to top right of full page view for better visibility
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      ...
                      if (newWindow) {
                        // Create download buttons at the top of the page
                        let downloadButtons = `
                          <div style="position: fixed; top: 70px; right: 20px; display: flex; gap: 8px; z-index: 1000;">
                            <button style="background: #f1f5f9; border: 1px solid #e2e8f0; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px; display: flex; align-items: center; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" onclick="exportTableToCSV('${displayName}_data.csv')">
                              <span style="margin-right: 4px;">📄</span> Excel/CSV
                            </button>
                            <button style="background: #f1f5f9; border: 1px solid #e2e8f0; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px; display: flex; align-items: center; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" onclick="exportToPDF()">
                              <span style="margin-right: 4px;">📑</span> PDF
                            </button>
                            <button style="background: #f1f5f9; border: 1px solid #e2e8f0; padding: 6px 12px; border-radius: 4px; cursor: pointer; font-size: 12px; display: flex; align-items: center; box-shadow: 0 2px 5px rgba(0,0,0,0.1);" onclick="exportToPNG()">
